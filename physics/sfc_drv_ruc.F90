...
! --- local
      ...
      real (kind=kind_phys), dimension(im,kice) :: tsice
...
!  ---  input:
      ...
      integer, intent(in) :: im, nlev, iter, lsoil_ruc, lsoil, kdt, isot, ivegsrc, nlunit
      integer, intent(in) :: lsm_ruc, lsm
...
!  ---  in/out:
      ...
      real (kind=kind_phys), dimension(lsoil_ruc) :: zs, dzs
...
!! This subroutine contains RUC LSM initialization.
      ...
      real (kind=kind_phys), dimension(im,lsoil_ruc), intent(out) :: smois! ruc
      real (kind=kind_phys), dimension(im,lsoil_ruc), intent(out) :: tslb ! ruc
      real (kind=kind_phys), dimension(im,lsoil_ruc), intent(out) :: sh2o ! ruc
      real (kind=kind_phys), dimension(im,lsoil_ruc), intent(out) :: smfrkeep ! ruc
      real (kind=kind_phys), dimension(im,lsoil_ruc), intent(out) :: tsice    ! ruc ice
